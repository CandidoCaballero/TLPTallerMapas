...
class FillPlace extends AsyncTask<String, Void, ArrayList<String>>
{
	...
	protected ArrayList<String> doInBackground(String... args) {
		...
		try{
			...
			URL googlePlaces = new URL("https://maps.googleapis.com/maps/api/place/autocomplete/json?input="+ URLEncoder.encode(args[0], "UTF-8") +"&types=geocode&language=en&sensor=true&key=KEY");
